...
-- LazyVim вмикає spell для markdown/txt з англійським словником, і весь
-- український текст світиться хвилястим підкресленням. Перенос рядків
-- у цих файлах корисний, тому лишаємо тільки його.
